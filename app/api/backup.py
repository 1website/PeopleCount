    ...
    try:
        ...
        for m in data.get("members", []):
            ...
            db.add(Member(
                ...
                dropout_status="NONE" if m.get("education_status") == "NONE" else m.get("dropout_status", "ACTIVE"),
                dropout_grade=None if m.get("education_status") == "NONE" else m.get("dropout_grade"),
